...
# start, dye-release, end
time_ranges = Dict("11-23" => (DateTime(2020, 11, 23, 17, 56),
                               DateTime(2020, 11, 23, 18, 53),
                               DateTime(2020, 11, 23, 19, 20)),

                   "12-09" => (DateTime(2020, 12, 09, 13, 47, 44),
                               DateTime(2020, 12, 09, 14, 40, 00),
                               DateTime(2020, 12, 09, 14, 54, 00)),


                   "12-10" => (DateTime(2020, 12, 10, 15, 18, 00),
                               DateTime(2020, 12, 10, 18, 13, 00),
                               DateTime(2020, 12, 10, 18, 43, 00)),
)
